...
const After = () => {
  return (
    ...
    <div className='flex items-center justify-center p-4 bg-neutral-100'>
      <div className='flex w-full h-full border-t-2 border-l-2 border-gray-300 rounded-tl-lg  p-4 bg-white'>
    ...
    <div className='flex items-center justify-center p-4 bg-neutral-800'>
      <div className='flex w-full h-full border-t-2 border-l-2 border-neutral-500 rounded-tl-lg  p-4 bg-neutral-600'>
        <div className='flex flex-col gap-2'>
