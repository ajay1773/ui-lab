...
const After = () => {
  return (
    <div className='flex w-full h-full border border-gray-300 rounded-lg px-4 py-2'>
      <div className='flex flex-col gap-2'>
        ...
        <button className='bg-teal-500 text-white px-4 py-1.5 text-sm rounded-md w-fit'>Apply</button>
      </div>
    </div>
  )
}
